// Operations portal layout – provides sidebar navigation and websocket connection
// Note: This file is created as part of implementing the Master Dashboard (S02)
// The layout mirrors the existing dashboard layout but limits to the operations
...
const NAV = [{ href: '/operations/dashboard', label: 'Dashboard', icon: '📊' }]
