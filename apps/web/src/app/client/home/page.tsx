      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-card rounded-lg shadow-md p-6 border border-border">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            >
              <p className="font-semibold text-card-foreground">📊 Dashboard</p>
            ...
            <a
              ...
              className="p-4 border border-border rounded-lg hover:bg-accent/10 transition-colors"
            >
              <p className="font-semibold text-card-foreground">🎮 Games</p>
              <p className="text-sm text-muted-foreground mt-1">Play games</p>
            </a>
          </div>
        </div>
      </div>
