...
export class AuthService {
  ...
  private async findUserWithRoles(email?: string, id?: string): Promise<UserWithRoles | null> {
  ...
  private async generateTokenPair(user: UserWithRoles) {
    ...
    const payload = { sub: user.id, email: user.email, roles, permissions, type: 'access' };
