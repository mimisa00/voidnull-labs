...
import { VerifyTotpDto, EnableTotpDto, RefreshTokenDto } from './dto/verify-totp.dto';
...
export class AuthController {
  ...
  async enableTotp(@CurrentUser() user: JwtPayload, @Body() dto: EnableTotpDto) {
  ...
  async disableTotp(@CurrentUser() user: JwtPayload, @Body() dto: EnableTotpDto) {
